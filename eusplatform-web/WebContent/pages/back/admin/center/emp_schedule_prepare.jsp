...
<%!
	...
	public static final String SUBMIT_TASK_ACTION = "pages/back/admin/center/CenterBackAction!submitTask.action" ;
%>
						...
						<tbody>
							<c:forEach items="${allSchedule }" var="schedule">
								<tr id="travel-${schedule.sid }">
									...
									<c:if test="${loginEid == schedule.seid }">
										<td class="text-center">
											<a type="button" class="btn btn-primary btn-xs" href="<%=SUBMIT_TASK_ACTION%>?sid=${schedule.sid}">
												<span class="fa fa-pencil-square-o"></span>&nbsp;提交任务</a>
										</td>
									</c:if>
								</tr> 
							</c:forEach>
