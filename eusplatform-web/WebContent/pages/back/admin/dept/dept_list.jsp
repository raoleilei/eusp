					...
					<tbody>
						<c:forEach items="${allDept }" var="dept">
							<tr>
								...
								<td class="text-center"><span id="eid-${dept.eid }" style="cursor:pointer;">${leaderEname[dept.eid] }</span></td> 
								<td class="text-center"><span class="text-danger" id="currnum-${dept.did }">${dept.currnum }</span></td>
